...
namespace metrics.Tests.Core
{
    ...
    public class HistogramMetricTests
    {
        ...
        {
            var underTest = new Histogram(Histogram.SampleType.Uniform);
            underTest.Update(9);
            underTest.Update(8);
        ...
        {
            var underTest = new Histogram(new RejectEverythingAboveTenSample());
            underTest.Update(11);
            underTest.Update(8);
        ...
        {
            var underTest = new Histogram(Histogram.SampleType.Biased);
            var sampleSize = 1028;
