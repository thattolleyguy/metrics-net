    ...
    public class MetricsTests
    {
        ...
        public void Can_get_same_metric_when_metric_exists()
        {
           // var metrics = new Metrics();
            var counter = _metrics.Counter("CounterTests.Can_get_same_metric_when_metric_exists");
            Assert.IsNotNull(counter);

            var same = _metrics.Counter( "CounterTests.Can_get_same_metric_when_metric_exists");
        ...
        public void Can_get_all_registered_metrics_as_readonly_and_immutable()
        {
            ...
            _metrics.Counter( "CounterTests.Can_get_all_registered_metrics_as_readonly_and_immutable");
            Assert.AreEqual(1, _metrics.All.Count);
        ...
        public void Can_get_metrics_from_collection_with_registered_changes()
        {
            ...
            var meter = _metrics.Meter( "MeterTests.meter", "test", TimeUnit.Seconds);
            Assert.IsNotNull(_metrics.All[name], "Metric not found in central registry");
            meter.Mark(3);
            actual = ((Meter)_metrics.All[name]).Count;
        ...
        public void Can_safely_remove_metrics_from_outer_collection_without_affecting_registry()
        {
            ...
            var meter = _metrics.Meter("MeterTests.Can_safely_remove_metrics_from_outer_collection_without_affecting_registry", "test", TimeUnit.Seconds);
            meter.Mark(3);
